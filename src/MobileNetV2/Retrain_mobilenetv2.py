...
WEIGHT_DIR = r"D:\Nethmyy__Research\Research_YOLO_model\Weight\mobilenet_weights\Mobilenetv2_Retrain_weight"
...
if checkpoint_path:
    print(f"🔁 Resuming Phase1 from {checkpoint_path}")
    model.load_weights(checkpoint_path)
else:
    print("🆕 Starting Phase1 from scratch")
    start_epoch = 0
...
if checkpoint_path2:
    print(f"🔁 Resuming Phase2 from {checkpoint_path2}")
    model.load_weights(checkpoint_path2)
else:
    print("🆕 Starting Phase2 from scratch")
    start_epoch2 = 0
...
print("\n🎉 MobileNetV2 Retraining Completed!")